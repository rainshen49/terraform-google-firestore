...
func TestExampleWithRules(t *testing.T) {
	...
	example.DefineVerify(func(assert *assert.Assertions) {
		...
		_, err = httpClient.Get(fmt.Sprintf("https://firebaserules.googleapis.com/v1/projects/%s/releases/cloud.firestore", projectId))
		if err != nil {
			t.Fatal(err.Error())
		}
	})
